...
const HomeHero = () => {
  return (
    <section className="w-full">
      {/* text-section */}
      <div className="container mb-8 flex max-w-[43.75rem] flex-col items-center justify-between text-center lg:mb-4 lg:max-w-none lg:flex-row lg:items-end lg:gap-16 lg:text-left">
        ...
        <p className="mt-6 text-[1.375rem] text-secondary lg:mt-0 lg:max-w-[453px]">
          From intimate gatherings to grand celebrations, Manville Manor offers
          the perfect space to make your event truly memorable.
        </p>
      </div>
